      ...
      child: RotatedBox(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            Sizedbox(width: 10.0),
            Text('${prod.bateria}', style: TextStyle(fontSize: 12.0)),
...
class _TarjetaDescripcion extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      elevation: 8,
      shpae: RoundedRectangleBorder( borderRadius: BorderRadius.circular(30)),
      child: ClipRRect(
            ...
            children: <Widget>[
              ...
              RotatedBox(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text(prod.titulo, style: TextStyle(color: Colors.white24, fontSize: 30, fontWeight: FontWeight.blod),),
                    Text(prod.subtitulo, style: TextStyle(color: Colors.white24, fontSize: 30, fontWeight: FontWeight.blod),),
                  ],
                ),
              ),
              Spacer(),
